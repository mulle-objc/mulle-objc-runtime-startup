...
if( NOT MULLE_OBJC_RUNTIME_LIBRARY)
   ...
   if( MULLE_OBJC_RUNTIME_LIBRARY)
      ...
      # Disable with: `mulle-sourcetree mark mulle-objc-runtime no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_OBJC_RUNTIME_NAME "mulle-objc-runtime")
         set( _TMP_MULLE_OBJC_RUNTIME_DIR "${_TMP_MULLE_OBJC_RUNTIME_ROOT}/include/${_TMP_MULLE_OBJC_RUNTIME_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_OBJC_RUNTIME_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_OBJC_RUNTIME_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
...
if( NOT MULLE_ATINIT_LIBRARY)
   ...
   if( MULLE_ATINIT_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark mulle-atinit no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_ATINIT_NAME "mulle-atinit")
         set( _TMP_MULLE_ATINIT_DIR "${_TMP_MULLE_ATINIT_ROOT}/include/${_TMP_MULLE_ATINIT_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_ATINIT_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_ATINIT_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
...
if( NOT MULLE_ATEXIT_LIBRARY)
   ...
   if( MULLE_ATEXIT_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark mulle-atexit no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_ATEXIT_NAME "mulle-atexit")
         set( _TMP_MULLE_ATEXIT_DIR "${_TMP_MULLE_ATEXIT_ROOT}/include/${_TMP_MULLE_ATEXIT_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_ATEXIT_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_ATEXIT_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
...
if( NOT MULLE_DLFCN_LIBRARY)
   ...
   if( MULLE_DLFCN_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark mulle-dlfcn no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_DLFCN_NAME "mulle-dlfcn")
         set( _TMP_MULLE_DLFCN_DIR "${_TMP_MULLE_DLFCN_ROOT}/include/${_TMP_MULLE_DLFCN_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_DLFCN_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_DLFCN_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
