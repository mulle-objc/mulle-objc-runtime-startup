#ifndef mulle_objc_runtime_startup_include_private_h__
#define mulle_objc_runtime_startup_include_private_h__
...
#include "_mulle-objc-runtime-startup-include-private.h"
