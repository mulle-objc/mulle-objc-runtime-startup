#ifndef mulle_objc_runtime_startup_include_h__
#define mulle_objc_runtime_startup_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "mulle-objc-runtime-startup-include.h" to keep the #include statements in the
...
#include "_mulle-objc-runtime-startup-include.h"
